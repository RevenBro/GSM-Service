        ...
        <nav className="flex items-center space-x-6 z-50">
            ...
            {isDropdownOpen && (
              <ul className="absolute right-0 mt-2 w-32 bg-white text-gray-900 rounded-lg shadow-lg overflow-hidden">
                <li>
                  <a
                    href="#"
                    className="block px-4 py-2 hover:bg-gray-200 hover:text-[#14b8a6]"
                  >
                    O'zbek
                  </a>
                </li>
          ...
          <div className="hidden md:block">
            <input
              type="text"
              placeholder="Search..."
              className="px-3 py-2 rounded bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-teal-400"
            />
          </div>

          <div className="hidden md:block">
            <button onClick={handleLoginClick} className="px-4 py-2 bg-teal-400 text-white rounded hover:bg-teal-500 focus:outline-none">Login</button>
          </div>
        </nav>

        {isMenuOpen && (
          <div className="md:hidden flex flex-col space-y-4 mt-4">
            <Link to="/" className="block text-teal-400 hover:text-teal-300">
              Asosiy
            </Link>
            <Link to="/contact" className="block text-teal-400 hover:text-teal-300">
              Bog'lanish
            </Link>
            <Link to="FAQ" className="block text-teal-400 hover:text-teal-300">
              FAQ
            </Link>
            <input
              type="text"
